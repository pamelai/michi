...
@section('title', "Pedidos entregados y anulados | Michi")
...
@section('main')
    <section class="container mt-4 mb-4 estaditicas">
        <div class="row justify-content-center">
            ...
            <h2 class="text-center col-12">Pedidos entregados y anulados</h2>
            ...
            <div class="dropdown col-4 col-md-3 col-lg-2 p-0 mt-4">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="dropdown-item text-center">
                        <a class="text-dark d-block" href="{{route('panel.pedidos-entregados-anulados-todos')}}">Todos</a>
                    </li>
                    @endif
                    @foreach($pedidos["meses_disponibles"] as $mes)
                        @if($mes != $pedidos["mes_consultado"])
                            <li class="dropdown-item text-center">
                                <a class="text-dark d-block" href="{{route('panel.pedidos-entregados-anulados', ["anio"=>explode("/",$mes)[0], "mes"=>explode("/",$mes)[1]])}}">{{$mes}}</a>
                            </li>
                        @endif
                    @endforeach
                </ul>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ['{{$ped->estado->estado}}', {{$ped->cantidad}}],
                @endforeach
            ]);
            ...
            var chart = new google.visualization.PieChart(document.getElementById('pedidos-entregados'));
